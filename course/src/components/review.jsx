        ...
        <div className="relative">
          <div className="flex overflow-x-auto space-x-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-black p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex-none w-64"
              >
                <div className="flex flex-col items-center text-center mb-4">
                  ...
                  <blockquote className="italic text-white mb-4 text-sm">
                    {testimonial.text}
                  </blockquote>
                  <p className="text-md text-gray-300 font-semibold mb-1">
                    {testimonial.author}
                  </p>
                  <p className="text-xs text-gray-400 mb-2">{testimonial.position}</p>
                </div>
